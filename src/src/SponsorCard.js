...
const cardStyle = { border: `1px solid ${ColorCode.darkBlue}` };
const buttonStyle = { backgroundColor: ColorCode.darkBlue, borderColor: ColorCode.darkBlue };
  ...
  return (
    <Card style={cardStyle}>
      ...
      <Card.Body>
        ...
        <Card.Title style={{ color: ColorCode.darkBlue }}>{sponsor}</Card.Title>
        <Card.Text>
          {text}
        </Card.Text>
      </Card.Body>
...
function bigCard(date, sponsor, text, logo, grants, longText, showOneCard) {
  ...
  return (
    <Card style={cardStyle}>
      <Card.Body>
        <Card.Title style={{ color: ColorCode.darkBlue }}>{sponsor} ({date}, {total})</Card.Title>
        <Card.Text as='div'>
